...
var link = {};
  link["cpp"] = "https://cpp-collegeek.herokuapp.com/";
  link["java"] = "https://java-collegeek.herokuapp.com/";
  link["c"] = "https://c-collegeek.herokuapp.com/";
  link["javascript"] = "https://javascript-collegeek.herokuapp.com/";
  link["python3"] = "https://python-collegeek.herokuapp.com/";

function setupEditor() {
  document.getElementById('output').value="";
  document.getElementById('theme').value="ace/theme/cobalt";
  document.getElementById('modes').value="ace/mode/javascript";
  ...
  editor.setValue(language["javascript"],1);
